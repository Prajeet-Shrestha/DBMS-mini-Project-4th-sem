...
class OperatorWindow(BoxLayout):
    ...
    def add_dealer_field(self):
        ...
        e1 = TextInput(hint_text=dealer_attr[0])
        e2 = TextInput(hint_text=dealer_attr[1])
        submit = Button(text='Add',
                        size_hint_x=None,
                        width=100,
                        on_release=lambda x: self.add_dealer(e1.text,e2.text))
        clear= Button(text='Clear',size_hint_x=None,width=100,on_release=lambda x:self.clear_dealer())
    ...
    def update_post_field(self):
        ...
        target.clear_widgets()
        e1 = TextInput(hint_text=post_attr[0])
        e2 = TextInput(hint_text=post_attr[1])
        e3 = TextInput(hint_text=post_attr[2])
        e4 = TextInput(hint_text="Insert Branch")
        e5 = TextInput(hint_text="Insert Title")
        update = Button(text='Update',
                        size_hint_x=None,
                        width=100,
                        on_release=lambda x: self.update_post(e1.text,e2.text,e3.text,e4.text,e5.text))
        
        clear= Button(text='Clear',size_hint_x=None,width=100,on_release=lambda x:self.clear_post())
    ...
    def update_employee_field(self):
        ...
        target.clear_widgets()
        e1 = TextInput(hint_text=employee_attr[0])
        e2 = TextInput(hint_text=employee_attr[1])
        e3 = TextInput(hint_text=employee_attr[2])
        e4 = TextInput(hint_text=employee_attr[3])
        e5 = TextInput(hint_text=employee_attr[4])
        e6 = TextInput(hint_text=employee_attr[5])
        e7 = TextInput(hint_text=employee_attr[6])
        e8 = TextInput(hint_text=employee_attr[7])
        e9 = TextInput(hint_text=employee_attr[8])
        e10 = TextInput(hint_text=employee_attr[9])
        e11 = TextInput(hint_text=employee_attr[10])
        e12 = TextInput(hint_text=employee_attr[11])
        e13 = TextInput(hint_text=employee_attr[12])
        ...
        Update = Button(text='Update',
                        ...
                        on_release=lambda x: self.update_employee(e1.text,
                                                                ...
                                                                e9.text,
                                                                e10.text,
                                                                e11.text,e12.text,e13.text,e14.text))
        clear= Button(text='Clear',size_hint_x=None,width=100,on_release=lambda x:self.clear_employee())
    ...
    def update_employee(self,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12,a13,a14):
        if a14 == "" :
            ...
            try:
                ...
                cursor.execute(update_query % (self.username.text, self.passcode.text, self.firstName.text, self.middleName.text, self.lastName.text, self.gender.text, self.dob.text, self.address.text, self.email.text, self.contactNum.text, self.status.text, self.branch.text, self.position.text, self.temp_username))
                db.commit()
                self.display_employee()
